...
var engine, world;
var ball, slingshot;
var ground,leftWall,rightWall,roof,platform;
...
function setup(){
    ...
    slingshot = new Slingshot(400,300,ball.body);
    ground = new Ground(600,570,1500,20);
    leftWall = new Ground(window.innerWidth,window.innerHeight/2,80,700);
    rightWall = new Ground(0,window.innerHeight/2,50,700);
    roof = new Ground(window.innerWidth/2,10,window.innerWidth,30);
    platform = new Ground(770,400,200,30);
